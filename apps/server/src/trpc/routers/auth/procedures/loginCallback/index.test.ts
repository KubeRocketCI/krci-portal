...
describe("authLoginCallbackProcedure", () => {
  ...
  it("should throw error if session.login is undefined", async () => {
    ...
    expect(openIdClient.fetchProtectedResource).not.toHaveBeenCalled();
  });
  ...
  it("should handle token exchange failure", async () => {
    ...
    vi.spyOn(openIdClient, "authorizationCodeGrant").mockRejectedValueOnce(
  ...
  it("should handle user info fetch failure", async () => {
    ...
    vi.spyOn(openIdClient, "fetchProtectedResource").mockRejectedValueOnce(
