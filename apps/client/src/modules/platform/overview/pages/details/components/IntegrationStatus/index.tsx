...
import { Plug, CheckCircle, AlertTriangle, ChevronDown, Loader2 } from "lucide-react";
    ...
    <Card className="border">
      <CardContent className="p-5">
        <div className="mb-3 flex items-center gap-2">
          <Plug className="size-4" style={{ color: MAIN_COLOR.BLUE }} />
          <h2 className="text-foreground text-base font-medium">Integrations</h2>
        </div>
                ...
                {configured.map((integration) => (
                  <div key={integration.name} className="flex items-center gap-1.5 py-0.5">
                    <span
                      ...
                      style={{ backgroundColor: STATUS_COLOR.SUCCESS }}
                    />
