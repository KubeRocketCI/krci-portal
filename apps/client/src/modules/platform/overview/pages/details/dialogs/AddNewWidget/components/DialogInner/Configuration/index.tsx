...
const widgetFormRenderer = (widgetType: WidgetType, addButtonContainerRef: React.RefObject<HTMLDivElement | null>) => {
  switch (widgetType) {
    case WIDGET_TYPE.APP_VERSION:
      return <AppVersionWidgetForm widgetType={widgetType} addButtonContainerRef={addButtonContainerRef} />;
    default:
      return null;
  }
};
