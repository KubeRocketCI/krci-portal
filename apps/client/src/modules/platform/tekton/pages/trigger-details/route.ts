...
export const PATH_TRIGGER_DETAILS_FULL =
  "/c/$clusterName/configuration/webhook-triggers/triggers/$namespace/$name" as const;
export const ROUTE_ID_TRIGGER_DETAILS =
  "/_layout/c/$clusterName/configuration/webhook-triggers/triggers/$namespace/$name" as const;
