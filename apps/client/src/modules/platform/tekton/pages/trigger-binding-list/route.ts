...
export const PATH_TRIGGER_BINDINGS_FULL = "/c/$clusterName/configuration/webhook-triggers/trigger-bindings" as const;
export const ROUTE_ID_TRIGGER_BINDINGS =
  "/_layout/c/$clusterName/configuration/webhook-triggers/trigger-bindings" as const;
