...
export const PATH_EVENT_LISTENERS_FULL = "/c/$clusterName/configuration/webhook-triggers/event-listeners" as const;
export const ROUTE_ID_EVENT_LISTENERS =
  "/_layout/c/$clusterName/configuration/webhook-triggers/event-listeners" as const;
