...
export const PATH_EVENT_LISTENER_DETAILS_FULL =
  "/c/$clusterName/configuration/webhook-triggers/event-listeners/$namespace/$name" as const;
export const ROUTE_ID_EVENT_LISTENER_DETAILS =
  "/_layout/c/$clusterName/configuration/webhook-triggers/event-listeners/$namespace/$name" as const;
