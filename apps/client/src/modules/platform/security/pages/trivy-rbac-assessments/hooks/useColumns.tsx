    ...
    () => [
      {
        ...
        data: {
          ...
          render: ({ data }) => {
            const resourceName =
              data.metadata?.labels?.[rbacAssessmentReportLabels.resourceName] || data.metadata?.name || "-";
            return (
              <Link
                to={PATH_TRIVY_RBAC_ASSESSMENT_DETAILS_FULL}
                params={{
      ...
      },
      {
        ...
        label: "Resource Kind",
        data: {
          columnSortableValuePath: `metadata.labels.${rbacAssessmentReportLabels.resourceKind}`,
          render: ({ data }) => {
            const resourceKind = data.metadata?.labels?.[rbacAssessmentReportLabels.resourceKind] || "-";
            return (
