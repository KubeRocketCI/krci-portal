...
export function IssueDetailDialog({ issue, components, open, onOpenChange }: IssueDetailDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl">
        <DialogHeader>
          ...
          <DialogDescription className="text-base">{issue.message}</DialogDescription>
        </DialogHeader>
