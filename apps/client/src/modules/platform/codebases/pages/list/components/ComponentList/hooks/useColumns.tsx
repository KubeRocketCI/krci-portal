...
import { getCodebaseMappingByType, getCodebaseStatusIcon } from "@my-project/client/core/k8s/api/KRCI/Codebase";
import { CodebaseInterface } from "@my-project/client/core/k8s/api/KRCI/Codebase/configs/mappings/types";
