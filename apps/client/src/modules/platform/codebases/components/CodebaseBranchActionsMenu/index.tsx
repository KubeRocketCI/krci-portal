...
import { useConflictedCDPipeline } from "./hooks/useDeletionConflictItem";
...
export const CodebaseBranchActionsMenu = ({
  ...
  const onBeforeSubmit = React.useCallback(
    async (handleError, setLoadingActive) => {
      ...
      handleError(<ConflictItemError conflictedCDPipeline={conflictedCDPipeline} name={branch?.spec.branchName} />);
      setLoadingActive(false);
    },
