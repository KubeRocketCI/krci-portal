...
import { CODEBASE_COMMON_LANGUAGES } from "@my-project/client/core/k8s/api/KRCI/Codebase/configs/mappings";
import {
  CodebaseInterface,
  CodebaseMappingItemInterface,
} from "@my-project/client/core/k8s/api/KRCI/Codebase/configs/mappings/types";
import { getCodebaseMappingByType } from "@my-project/client/core/k8s/api/KRCI/Codebase";
