...
import { createResourceDraft } from "@my-project/shared/src/models/k8s/groups/KRCI/Codebase/utils/createResourceDraft";
...
export const Configuration = ({ baseDefaultValues, setActiveTab }: ConfigurationProps) => {
  ...
  const handleOpenEditor = React.useCallback(() => {
    ...
    const newCodebaseData = createResourceDraft(CODEBASE_FORM_NAMES, usedValues);
