  ...
  return [
    {
      ...
      icon: <CloudCog size={24} className="text-foreground" />,
    },
    {
      ...
      icon: <LayoutGrid size={24} className="text-foreground" />,
    },
    {
