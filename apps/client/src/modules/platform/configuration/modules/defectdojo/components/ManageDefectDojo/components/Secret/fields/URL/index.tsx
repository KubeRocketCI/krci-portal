  ...
  return (
    <FormTextFieldEditable
      ...
      tooltipText={
        <>
          <p>
            Specify the URL where users can access the DefectDojo interface. Ensure to include the HTTP or HTTPS
            protocol in the address (e.g., <em>https://defectdojo.example.com</em>).
          </p>
        </>
      }
