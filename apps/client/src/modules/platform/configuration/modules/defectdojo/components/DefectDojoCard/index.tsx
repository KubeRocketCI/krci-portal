...
import { DefectDojoActionsMenu } from "../DefectDojoActionsMenu";

interface DefectDojoCardProps {
  secret: Secret;
...
export function DefectDojoCard({ secret, quickLink, ownerReference, onEdit }: DefectDojoCardProps) {
      ...
      <IntegrationCard.Header
        ...
        actions={
          <DropdownMenu>
            ...
            <DefectDojoActionsMenu secret={secret} ownerReference={ownerReference} onEdit={onEdit} />
          </DropdownMenu>
        }
      />
