  ...
  return (
    <FormTextField
      {...register(QUICK_LINK_FORM_NAMES.EXTERNAL_URL, {
        required: "Enter the external Chat Assistant URL.",
        pattern: {
        ...
        onChange: ({ target: { value } }) => {
          ...
          secret.form.setValue(INTEGRATION_SECRET_FORM_NAMES.API_URL, value);
        },
      })}
      label={"Quick Link URL"}
      tooltipText={"Enter the external URL of your Chat Assistant instance."}
