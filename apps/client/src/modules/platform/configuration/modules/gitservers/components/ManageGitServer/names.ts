...
/**
 * Field names for the unified GitServer integration form
 */
export const NAMES = {
  // GitServer fields
  NAME: "name",
...
const baseSchema = z.object({
  [NAMES.NAME]: z
    ...
    .regex(nameRequirementRegex, "Name must contain only lowercase letters, numbers, and dashes. It cannot start or end with a dash."),
