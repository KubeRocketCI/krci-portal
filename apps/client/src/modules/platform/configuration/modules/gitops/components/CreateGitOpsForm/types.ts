...
export interface CreateGitOpsFormProps {
  onClose: () => void;
}

export type CreateGitOpsFormValues = {
  ...
  [CODEBASE_FORM_NAMES.UI_GIT_SERVER_PROVIDER]?: string;
  [CODEBASE_FORM_NAMES.UI_REPOSITORY_OWNER]?: string;
  [CODEBASE_FORM_NAMES.UI_REPOSITORY_NAME]?: string;
