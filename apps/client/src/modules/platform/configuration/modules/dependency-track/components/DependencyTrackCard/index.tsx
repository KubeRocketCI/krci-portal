...
import { DependencyTrackActionsMenu } from "../DependencyTrackActionsMenu";

interface DependencyTrackCardProps {
  secret: Secret;
...
export function DependencyTrackCard({ secret, quickLink, ownerReference, onEdit }: DependencyTrackCardProps) {
      ...
      <IntegrationCard.Header
        ...
        actions={
          <DropdownMenu>
            ...
            <DependencyTrackActionsMenu secret={secret} ownerReference={ownerReference} onEdit={onEdit} />
          </DropdownMenu>
        }
      />
