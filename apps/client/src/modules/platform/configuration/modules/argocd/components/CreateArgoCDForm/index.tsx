...
export const CreateArgoCDForm: React.FC<CreateArgoCDFormProps> = ({ quickLink, onClose }) => {
  ...
  const handleSubmit = React.useCallback(
    async (values: CreateArgoCDFormValues) => {
      const loadingToastId = showToast("Creating ArgoCD integration", "loading");
      try {
        ...
        showToast(result.data?.message || "ArgoCD integration created successfully", "success", {
          id: loadingToastId,
          duration: 5000,
        });
        onClose();
        ...
        showToast("Failed to create ArgoCD integration", "error", {
          id: loadingToastId,
          duration: 10000,
