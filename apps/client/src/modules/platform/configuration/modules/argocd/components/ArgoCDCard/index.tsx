...
import { ArgoCDActionsMenu } from "../ArgoCDActionsMenu";

interface ArgoCDCardProps {
  secret: Secret;
...
export function ArgoCDCard({ secret, quickLink, ownerReference, onEdit }: ArgoCDCardProps) {
      ...
      <IntegrationCard.Header
        ...
        actions={
          <DropdownMenu>
            ...
            <ArgoCDActionsMenu secret={secret} ownerReference={ownerReference} onEdit={onEdit} />
          </DropdownMenu>
        }
      />
