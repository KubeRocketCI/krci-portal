...
/**
 * Rendered inside ManageArgoCDFormProvider so it has access to the form via useManageArgoCDForm().
...
const FormContent = ({
  ...
  ownerReference,
  mode,
}: Pick<ManageArgoCDCIProps, "secret" | "ownerReference" | "mode">) => {
        ...
        <AccordionTrigger className="cursor-default">
          <div className="flex w-full items-center justify-between">
            <div className="flex w-full flex-col items-start gap-1">
              ...
              <p className="text-muted-foreground text-sm">Argo CD</p>
            </div>
            <ConditionalWrapper
              condition={!canDelete}
              wrapper={(children) => (
