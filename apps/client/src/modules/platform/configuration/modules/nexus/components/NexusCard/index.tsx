...
import { NexusActionsMenu } from "../NexusActionsMenu";
...
export function NexusCard({ secret, quickLink, ownerReference, onEdit }: NexusCardProps) {
  ...
  return (
    <IntegrationCard>
      <IntegrationCard.Header
        ...
        subtitle="Nexus Repository Manager"
        actions={
          <DropdownMenu>
            ...
            <NexusActionsMenu secret={secret} ownerReference={ownerReference} onEdit={onEdit} />
          </DropdownMenu>
        }
      />
