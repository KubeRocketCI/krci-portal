import { BUILD_TOOL_ICON_MAPPING, FRAMEWORK_ICON_MAPPING, LANGUAGE_ICON_MAPPING } from "../../icon-mappings";
...
export type AutotestLanguageKeys = typeof CODEBASE_COMMON_LANGUAGES.JAVA | typeof CODEBASE_COMMON_LANGUAGES.OTHER;
