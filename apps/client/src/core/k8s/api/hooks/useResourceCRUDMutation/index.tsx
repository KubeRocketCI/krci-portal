...
type UseResourceCRUDMutationReturnType<KubeObjectData, Operation extends K8sOperation> = Operation extends typeof k8sOperation.delete
  ? void
  : KubeObjectData;
...
): UseMutationResult<UseResourceCRUDMutationReturnType<KubeObjectData, Operation>, Error, MutationInput<KubeObjectData>> => {
