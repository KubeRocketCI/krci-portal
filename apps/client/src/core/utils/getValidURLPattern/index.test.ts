...
describe("URL validation", () => {
  ...
  it("should return false for non valid https url", () => {
    expect(getValidURLPattern(VALIDATED_PROTOCOL.STRICT_HTTPS).test("http://google.com")).toBe(false);
  });

  it("should return true for valid https url", () => {
    expect(getValidURLPattern(VALIDATED_PROTOCOL.STRICT_HTTPS).test("https://google.com")).toBe(true);
  });

  it("should return false for non valid http url", () => {
    expect(getValidURLPattern(VALIDATED_PROTOCOL.STRICT_HTTP).test("https://google.com")).toBe(false);
  });
  ...
  it("should return false for non valid no protocol url", () => {
    expect(getValidURLPattern(VALIDATED_PROTOCOL.NO_PROTOCOL).test("https://google.com")).toBe(false);
  });
