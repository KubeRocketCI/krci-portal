...
describe("createResourceAction", () => {
  describe("protection label normalization", () => {
    ...
    it("should handle 'update' protection label (K8s operation)", () => {
      const item = mockItem("update");
      const protection = getResourceProtection(item, k8sOperation.update);
    ...
    it("should handle combined 'update-delete' protection label", () => {
      ...
      const patchProtection = getResourceProtection(item, k8sOperation.update);
    ...
    it("should create action with correct properties", () => {
      ...
      expect(action.name).toBe(k8sOperation.update);
