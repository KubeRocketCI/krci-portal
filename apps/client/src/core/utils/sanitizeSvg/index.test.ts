...
describe("sanitizeSvgBase64", () => {
  ...
  it("should preserve valid SVG content", () => {
    const validSvg = btoa('<svg xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="40"/></svg>');
  ...
  it("should remove event handlers", () => {
    const svgWithEventHandler = btoa('<svg onclick="alert(\'XSS\')"><circle cx="50" cy="50" r="40"/></svg>');
