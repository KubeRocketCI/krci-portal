...
describe("getIconByPattern", () => {
  ...
  describe("Pattern ordering verification", () => {
    test("should have both javascript and java patterns present", () => {
      ...
      const javaIndex = CODEBASE_ICON_PATTERNS.findIndex((pattern) => pattern.pattern.source.includes("^java"));
    ...
    test("should verify cmake comes before make in patterns", () => {
      const cmakeIndex = CODEBASE_ICON_PATTERNS.findIndex((pattern) => pattern.pattern.source === "^cmake$");
      const makeIndex = CODEBASE_ICON_PATTERNS.findIndex((pattern) => pattern.pattern.source === "^make$");
    ...
    test("should verify nextjs comes before react in patterns", () => {
      const nextjsIndex = CODEBASE_ICON_PATTERNS.findIndex((pattern) => pattern.pattern.source.includes("nextjs"));
      const reactIndex = CODEBASE_ICON_PATTERNS.findIndex((pattern) => pattern.pattern.source === "^react$");
