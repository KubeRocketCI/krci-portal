...
import { PATH_TEKTON_RESULT_PIPELINERUN_DETAILS_FULL } from "@/modules/platform/pipelineruns/pages/tekton-result-details/route";
import { getTektonResultStatusIcon } from "@/modules/platform/pipelineruns/utils/statusIcons";
