...
export const LANGUAGE_ICON_MAPPING = {
  ...
  [CODEBASE_COMMON_LANGUAGES.C]: RESOURCE_ICON_NAMES.C,
  [CODEBASE_COMMON_LANGUAGES.CPP]: RESOURCE_ICON_NAMES.CPP,
...
export const FRAMEWORK_ICON_MAPPING = {
  ...
  [CODEBASE_COMMON_FRAMEWORKS.JAVA21]: RESOURCE_ICON_NAMES.JAVA,
  ...
  [CODEBASE_COMMON_FRAMEWORKS.NONE]: RESOURCE_ICON_NAMES.NONE,
} as const;
...
export const BUILD_TOOL_ICON_MAPPING = {
  ...
  [CODEBASE_COMMON_BUILD_TOOLS.MAKE]: RESOURCE_ICON_NAMES.MAKE,
  [CODEBASE_COMMON_BUILD_TOOLS.C_MAKE]: RESOURCE_ICON_NAMES.C_MAKE,
} as const;
