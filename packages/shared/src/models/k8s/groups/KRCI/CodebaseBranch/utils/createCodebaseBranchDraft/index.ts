...
import { codebaseBranchLabels, k8sCodebaseBranchConfig } from "../../constants";
import { codebaseBranchDraftSchema } from "../../schema";
import { CodebaseBranchDraft } from "../../types";
import { truncateName } from "@my-project/shared/utils/truncateName";
import { createRandomString } from "@my-project/shared/utils/createRandomString";
