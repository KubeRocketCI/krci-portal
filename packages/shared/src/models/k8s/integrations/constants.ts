...
export const SECRET_LABEL_INTEGRATION_SECRET =
  "app.edp.epam.com/integration-secret";
...
export const SECRET_ANNOTATION_CLUSTER_CONNECTED =
  "app.edp.epam.com/cluster-connected";
