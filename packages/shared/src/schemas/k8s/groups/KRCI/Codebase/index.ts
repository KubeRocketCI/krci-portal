import { z } from "zod";
import { kubeObjectBaseSchema } from "../../../Base";

const codebaseSpecSchema = z
  .object({
    ...
    ciTool: z
      .string()
      .default("tekton")
      .describe("A name of tool which should be used as CI."),
    ...
    description: z
      ...
      .nullable()
      .optional()
      .describe("A short description of codebase."),
    ...
    type: z
      .string()
      .describe("Type of codebase. E.g. application, autotest or library."),
    versioning: z
      .object({
        startFrom: z
          .string()
...
const codebaseSchema = kubeObjectBaseSchema
  .extend({
    spec: codebaseSpecSchema.required({
      buildTool: true,
      defaultBranch: true,
      emptyProject: true,
      framework: true,
