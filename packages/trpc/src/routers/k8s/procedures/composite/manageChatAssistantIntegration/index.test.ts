...
describe("k8sManageChatAssistantIntegrationProcedure", () => {
  ...
  const mockQuickLink: QuickLink = {
    ...
    kind: "QuickLink",
    metadata: { name: "chat-assistant", namespace: "test-namespace" },
    spec: { type: "chat-assistant", url: "https://chat.example.com", icon: "chat-assistant", visible: true },
  };

  const mockSecret: Secret = {
    apiVersion: "v1",
    kind: "Secret",
    metadata: { name: "ci-chat-assistant", namespace: "test-namespace" },
    type: "Opaque",
    data: {
  ...
  describe("edit mode", () => {
    ...
    it("should only update quickLink when only quickLink is dirty", async () => {
      ...
      const updatedQuickLink = { ...mockQuickLink, spec: { ...mockQuickLink.spec, url: "https://chat-updated.example.com" } };
    ...
    it("should update both resources when both are dirty", async () => {
      ...
      const updatedQuickLink: QuickLink = { ...mockQuickLink, spec: { ...mockQuickLink.spec, url: "https://chat-updated.example.com" } };
