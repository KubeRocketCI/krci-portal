...
describe("k8sManageDefectDojoIntegrationProcedure", () => {
  ...
  const mockQuickLink: QuickLink = {
    ...
    kind: "QuickLink",
    metadata: { name: "defect-dojo", namespace: "test-namespace", uid: "", creationTimestamp: "" },
    spec: { type: "default", url: "https://defectdojo.example.com", icon: "defect-dojo", visible: true },
  };

  const mockSecret: Secret = {
    apiVersion: "v1",
    kind: "Secret",
    metadata: { name: "ci-defect-dojo", namespace: "test-namespace", uid: "", creationTimestamp: "" },
    type: "Opaque",
  ...
  describe("edit mode", () => {
    it("should only update secret when only secret is dirty", async () => {
      ...
      const updatedSecret = {
        ...mockSecret,
        data: { token: btoa("updated-token"), url: btoa("https://dd-new.example.com") },
      };
    ...
    it("should only update quickLink when only quickLink is dirty", async () => {
      const input = {
        ...
        quickLink: {
          name: "defect-dojo",
          externalUrl: "https://dd-updated.example.com",
      ...
      const updatedQuickLink = {
        ...mockQuickLink,
        spec: { ...mockQuickLink.spec, url: "https://dd-updated.example.com" },
      };
    ...
    it("should update both resources when both are dirty", async () => {
      ...
      const updatedSecret: Secret = {
        ...mockSecret,
        data: { token: btoa("updated-token"), url: btoa("https://dd-updated.example.com") },
      };
