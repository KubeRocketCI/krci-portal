...
describe("k8sManageDependencyTrackIntegrationProcedure", () => {
  ...
  const mockQuickLink: QuickLink = {
    ...
    kind: "QuickLink",
    metadata: { name: "dependency-track", namespace: "test-namespace", uid: "", creationTimestamp: "" },
    spec: { type: "default", url: "https://dependency-track.example.com", icon: "dependency-track", visible: true },
  };

  const mockSecret: Secret = {
    apiVersion: "v1",
    kind: "Secret",
    metadata: { name: "ci-dependency-track", namespace: "test-namespace", uid: "", creationTimestamp: "" },
    type: "Opaque",
  ...
  describe("edit mode", () => {
    it("should only update secret when only secret is dirty", async () => {
      ...
      const updatedSecret = {
        ...mockSecret,
        data: { token: btoa("updated-token"), url: btoa("https://dt-new.example.com") },
      };
    ...
    it("should only update quickLink when only quickLink is dirty", async () => {
      const input = {
        ...
        quickLink: {
          ...
          externalUrl: "https://dt-updated.example.com",
      ...
      const updatedQuickLink = {
        ...mockQuickLink,
        spec: { ...mockQuickLink.spec, url: "https://dt-updated.example.com" },
      };
    ...
    it("should update both resources when both are dirty", async () => {
      ...
      const updatedSecret: Secret = {
        ...mockSecret,
        data: { token: btoa("updated-token"), url: btoa("https://dt-updated.example.com") },
      };
