...
describe("handleK8sError", () => {
  ...
  describe("ApiException handling", () => {
    test("converts ApiException with numeric code", () => {
      const error = new ApiException(404, "Not Found", {} as unknown as { [key: string]: string }, {} as unknown as { [key: string]: string });
      const result = handleK8sError(error);
    ...
    test("parses JSON error body from ApiException", () => {
      ...
      const error = new ApiException(404, "Not Found", errorBody as unknown as { [key: string]: string }, {} as unknown as { [key: string]: string });
      const result = handleK8sError(error);
    ...
    test("handles non-JSON error body from ApiException", () => {
      const error = new ApiException(404, "Not Found", "Plain text error" as unknown as { [key: string]: string }, {} as unknown as { [key: string]: string });
      const result = handleK8sError(error);
    ...
    test("uses error.message as fallback when body parsing fails", () => {
      const error = new ApiException(404, "Not Found", "Invalid JSON {" as unknown as { [key: string]: string }, {} as unknown as { [key: string]: string });
      const result = handleK8sError(error);
    ...
    test("defaults to INTERNAL_SERVER_ERROR for non-numeric code", () => {
      const error = new ApiException("unknown" as unknown as number, "Error", {} as unknown as { [key: string]: string }, {} as unknown as { [key: string]: string });
      const result = handleK8sError(error);
