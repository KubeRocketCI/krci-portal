...
// OIDC login flow only on UNAUTHORIZED (see apps/client/src/core/providers/trpc/authErrorLink.ts
// isSessionAuthError). A role denial is not a session expiry and must not bounce an
